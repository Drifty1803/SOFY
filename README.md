...
<p align="center">
  <img src="public/screenshots/playback_1.png" alt="Screenshot 1" width="200" style="border-radius:16px;"/>
  <img src="public/screenshots/playback_2.png" alt="Screenshot 2" width="200" style="border-radius:16px;"/>
  <img src="public/screenshots/playlist_1.png" alt="Screenshot 3" width="200" style="border-radius:16px;"/>
  <img src="public/screenshots/playlist_2.png" alt="Screenshot 4" width="200" style="border-radius:16px;"/>
  <img src="public/screenshots/palette.png" alt="Screenshot 5" width="200" style="border-radius:16px;"/>
</p>
...
- **Customization** — Don't feel that algorhythm get the colors right? You can choose what colors are selected from album art.
...
| **Runtime / Bridge** | [Capacitor](https://capacitorjs.com/) |
...
1. **Clone the repository**
   ```sh
   git clone https://github.com/your-username/SOFY.git
   cd SOFY
   ```
...
5. **Open in Android Studio**
   ...
   **Shortcut:** You can also use the combined command `npm run android` to build and open the project in one step.
